...
class AuthServiceClass {
    async LoginUser({ email, password, }) {
        try {
            ...
            throw new AppError(error instanceof AppError ? error.message : "Failed to signin user", error instanceof AppError ? error.statusCode : 500);
        }
    }
    ;
    async getAuthenticatedUser(email) {
        try {
            ...
            throw new AppError(error instanceof AppError ? error.message : "Failed to get authenticated user", error instanceof AppError ? error.statusCode : 500);
        }
    }
}
